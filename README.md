...
[![Go Report Card](https://goreportcard.com/badge/github.com/AminoApps/casbin)](https://goreportcard.com/report/github.com/AminoApps/casbin)
[![Build Status](https://travis-ci.org/AminoApps/casbin.svg?branch=master)](https://travis-ci.org/AminoApps/casbin)
[![Coverage Status](https://coveralls.io/repos/github/AminoApps/casbin/badge.svg?branch=master)](https://coveralls.io/github/AminoApps/casbin?branch=master)
[![Godoc](https://godoc.org/github.com/AminoApps/casbin?status.svg)](https://godoc.org/github.com/AminoApps/casbin)
[![Release](https://img.shields.io/github/release/AminoApps/casbin.svg)](https://github.com/AminoApps/casbin/releases/latest)
...
[![golang](https://casbin.org/img/langs/golang.png)](https://github.com/AminoApps/casbin) | [![java](https://casbin.org/img/langs/java.png)](https://github.com/casbin/jcasbin) | [![nodejs](https://casbin.org/img/langs/nodejs.png)](https://github.com/casbin/node-casbin) | [![php](https://casbin.org/img/langs/php.png)](https://github.com/php-casbin/php-casbin)
----|----|----|----
[Casbin](https://github.com/AminoApps/casbin) | [jCasbin](https://github.com/casbin/jcasbin) | [node-Casbin](https://github.com/casbin/node-casbin) | [PHP-Casbin](https://github.com/php-casbin/php-casbin)
...
```
go get github.com/AminoApps/casbin
```
...
- [Management API](https://github.com/AminoApps/casbin/blob/master/management_api.go): the primitive API that provides full support for Casbin policy management. See [here](https://github.com/AminoApps/casbin/blob/master/management_api_test.go) for examples.
- [RBAC API](https://github.com/AminoApps/casbin/blob/master/rbac_api.go): a more friendly API for RBAC. This API is a subset of Management API. The RBAC users could use this API to simplify the code. See [here](https://github.com/AminoApps/casbin/blob/master/rbac_api_test.go) for examples.
...
[Filtered File Adapter (built-in)](https://github.com/AminoApps/casbin#policy-enforcement-at-scale) | File | [@faceless-saint](https://github.com/faceless-saint) | Persistence for [.CSV (Comma-Separated Values)](https://en.wikipedia.org/wiki/Comma-separated_values) files with policy subset loading support
...
----|----|----
[Default Role Manager (built-in)](https://github.com/AminoApps/casbin/blob/master/rbac/default-role-manager/role_manager.go) | Casbin | Supports role hierarchy stored in Casbin policy
...
For developers: all role managers must implement the [RoleManager](https://github.com/AminoApps/casbin/blob/master/rbac/role_manager.go) interface. [Session Role Manager](https://github.com/casbin/session-role-manager) can be used as a reference implementation.

## Multi-threading

If you use Casbin in a multi-threading manner, you can use the synchronized wrapper of the Casbin enforcer: https://github.com/AminoApps/casbin/blob/master/enforcer_synced.go.
...
The overhead of policy enforcement is benchmarked in [model_b_test.go](https://github.com/AminoApps/casbin/blob/master/model_b_test.go). The testbed is:
...
----|------|----
ACL | [basic_model.conf](https://github.com/AminoApps/casbin/blob/master/examples/basic_model.conf) | [basic_policy.csv](https://github.com/AminoApps/casbin/blob/master/examples/basic_policy.csv)
ACL with superuser | [basic_model_with_root.conf](https://github.com/AminoApps/casbin/blob/master/examples/basic_with_root_model.conf) | [basic_policy.csv](https://github.com/AminoApps/casbin/blob/master/examples/basic_policy.csv)
ACL without users | [basic_model_without_users.conf](https://github.com/AminoApps/casbin/blob/master/examples/basic_without_users_model.conf) | [basic_policy_without_users.csv](https://github.com/AminoApps/casbin/blob/master/examples/basic_without_users_policy.csv)
ACL without resources | [basic_model_without_resources.conf](https://github.com/AminoApps/casbin/blob/master/examples/basic_without_resources_model.conf) | [basic_policy_without_resources.csv](https://github.com/AminoApps/casbin/blob/master/examples/basic_without_resources_policy.csv)
RBAC | [rbac_model.conf](https://github.com/AminoApps/casbin/blob/master/examples/rbac_model.conf)  | [rbac_policy.csv](https://github.com/AminoApps/casbin/blob/master/examples/rbac_policy.csv)
RBAC with resource roles | [rbac_model_with_resource_roles.conf](https://github.com/AminoApps/casbin/blob/master/examples/rbac_with_resource_roles_model.conf)  | [rbac_policy_with_resource_roles.csv](https://github.com/AminoApps/casbin/blob/master/examples/rbac_with_resource_roles_policy.csv)
RBAC with domains/tenants | [rbac_model_with_domains.conf](https://github.com/AminoApps/casbin/blob/master/examples/rbac_with_domains_model.conf)  | [rbac_policy_with_domains.csv](https://github.com/AminoApps/casbin/blob/master/examples/rbac_with_domains_policy.csv)
ABAC | [abac_model.conf](https://github.com/AminoApps/casbin/blob/master/examples/abac_model.conf)  | N/A
RESTful | [keymatch_model.conf](https://github.com/AminoApps/casbin/blob/master/examples/keymatch_model.conf)  | [keymatch_policy.csv](https://github.com/AminoApps/casbin/blob/master/examples/keymatch_policy.csv)
Deny-override | [rbac_model_with_deny.conf](https://github.com/AminoApps/casbin/blob/master/examples/rbac_with_deny_model.conf)  | [rbac_policy_with_deny.csv](https://github.com/AminoApps/casbin/blob/master/examples/rbac_with_deny_policy.csv)
Priority | [priority_model.conf](https://github.com/AminoApps/casbin/blob/master/examples/priority_model.conf)  | [priority_policy.csv](https://github.com/AminoApps/casbin/blob/master/examples/priority_policy.csv)

## How to use Casbin as a service?

- [Casbin Server](https://github.com/AminoApps/casbin-server): The official ``Casbin as a Service`` solution based on [gRPC](https://grpc.io/), both Management API and RBAC API are provided.
...
- [Docker](https://github.com/docker/docker): The world's leading software container platform, via plugin: [casbin-authz-plugin](https://github.com/AminoApps/casbin-authz-plugin) ([recommended by Docker](https://docs.docker.com/engine/extend/legacy_plugins/#authorization-plugins))
...
- https://github.com/AminoApps/casbin/issues
- hsluoyz@gmail.com
